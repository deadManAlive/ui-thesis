...
+ Pada perbandingan denah ruang sederhana, terdapat peningkatan tingkat kesalahan pada posisi LOS, meskipun hal yang serupa tidak ditemukan pada simulasi ruang nyata. Dengan implementasi program yang hanya memodelkan refleksi, transmisi, dan difraksi, dan perbedaan utama antara denah sederhana dan denah nyata adalah bahwa denah ruang sederhana berupa poligin tertutup, seperti yang dapat dilihat pada @simplex, maka rugi jalur yang lebih kecil di area tersebut dapat dijelaskan sebagai efek dari amplifikasi sinar yang bergerak pada arah horizontal (pada tampilan aplikasi) pada ruang tertutup. Hal ini kontras dengan denah ruang nyata yang memberikan celah pada pintu utama denah, yang berada pada sumbu horizontal yang sama dengan titik sumber. Salah satu solusi yang mungkin dapat diberikan adalah pengimplementasian absorbsi dan batas atau _threshold_ sinar dengan nilai koefisien-koefisien tertentu.
